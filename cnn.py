...
def car_type(file_path):
    print("start cnn")
    # 模型目录
    CHECKPOINT_DIR = './static/car-type-classifier/runs/1533550478/checkpoints'
    INCEPTION_MODEL_FILE = './static/car-type-classifier/model/tensorflow_inception_graph.pb'
...
# 评估
    checkpoint_file = './static/car-type-classifier/runs/1533550478/checkpoints/model-1900'
    with tf.Graph().as_default() as graph:
        ...
        # 收集预测值
            ...
            print("识别结果："+str(all_predictions)[1:-1])
